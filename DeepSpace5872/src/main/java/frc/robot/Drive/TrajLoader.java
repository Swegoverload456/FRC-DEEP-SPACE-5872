...
public class TrajLoader {
    ...
    private static double [][] traj = new double[][]{

    };

    private static int kNumPoints = 0;
	 ...
	 */
	public TrajLoader(IMotorController motorController, double[][] trajectory, int numPoints) {
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			double positionRot = profile[i][3];
			double velocityRPM = profile[i][4];
